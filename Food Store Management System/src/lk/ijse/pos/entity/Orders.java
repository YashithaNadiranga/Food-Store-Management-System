...
public class Orders {
    ...
    public Orders(String orderid, String ctp, String method, String placeDT, String pickDT, String total, String status) {
    ...
    public String toString() {
        return "Orders{" + "orderid=" + orderid + ", ctp=" + ctp + ", method=" + method + ", placeDT=" + placeDT + ", pickDT=" + pickDT + ", total=" + total + ", status=" + status + '}';
    }
